  ...
  return (
    ...
    <div className='rounded-sm'>
      <div className="flex md:w-1/2 xl:w-2/5 2xl:w-full 3xl:w-1/3 mx-auto 3xl:p-14 rounded-2xl gap-5">
        <form className="w-full grid grid-cols-3 xl:grid-cols-1 gap-5 bg-gray-800 rounded-xl p-4" onSubmit={onSubmit} method='POST'>
         <div className='flex justify-between'> 
          <input type="hidden" name="access_key" value={process.env.REACT_APP_ACCESS_KEY} />
            <div className="pb-6">
